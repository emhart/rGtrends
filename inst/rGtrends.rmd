...
plot(twit_ms[,1],twit_ms[,3],type='l',col=2,xlab="Date",ylab="Search Volume",main="Rise of Twitter and fall of Myspace")
...
ggplot(gg_df, aes(x=Date,y=value,colour=variable)) + geom_path() + ylab("Search Volume")
```
